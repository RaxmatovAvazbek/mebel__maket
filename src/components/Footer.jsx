        ...
        <div className="mx-auto w-full max-w-screen-xl">
          ...
          <form class="flex items-center max-w-lg mx-auto">   
              ...
              <div class="relative w-full">
                  <input type="text" id="voice-search" class="bg-gray-50  text-gray-900 text-sm rounded-lg block w-full ps-10 p-2.5 input-class" placeholder="Enter Your Email Address" required />
              </div>
              <button type="submit" class="inline-flex items-center button-class py-2.5 px-3 ms-2 text-sm font-medium  text-black rounded-lg border">
              SUBSCRIBE
              </button>
          </form>
